...
function addressSearch() {
    ...
    var params = {
        'key': "AIzaSyB_LhG8DlRJEqa0TSoBlaY0BE7mw_RvJXo",
        'address': address
    }
    $.when($.getJSON(INFO_API, params)).then(function(data){
        ...
        if (divisions === undefined) {
            ...
            if (show_federal) {
                ...
                $('#fed-nav').show();
                $('#federal-results ').append(template.render({people: federal_people}));
            } else {
            ...
            if (show_state) {
                ...
                $('#state-results ').append(template.render({people: state_people}));
            } else {
                $('#state-container').hide()
                $('#state-nav').hide();
            }
            ...
            if (show_county) {
                ...
                $('#county-results ').append(template.render({people: county_people}));
            } else {
                $('#county-container').hide()
                $('#county-nav').hide();
            }
            ...
            if (show_local) {
                ...
                $('#local-results ').append(template.render({people: local_people}));
            } else {
                $('#local-container').hide()
                $('#local-nav').hide();
            }
